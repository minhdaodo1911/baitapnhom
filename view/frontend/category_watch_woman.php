<div class="list_product container">
	 				...
	 				<?php include "view/frontend/list_menu.php"; ?>
	 					...
	 					<div class="col-lg-9">
						<?php
						$data = model::list_all("select * from product_watch where fk_category_watch_id=7 or fk_category_watch_id=8 or fk_category_watch_id=9 order by pk_watch_id desc limit $from,$record_per_page"); ?>
                    ...
                    <li><a href="index.php?controller=category_watch_woman&p=<?php echo $i;?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
	 				</div>
	 			</div>
	 			</div>
