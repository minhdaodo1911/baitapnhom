<div class="list_product container">
	 				<div class="row">
	 					...
	 					<div class="col-lg-9">
                             ...
                             ?>
						<div class="new_pr col-lg-4"><a href="index.php?controller=detail_watch&id=<?php $rows->pk_watch_id; ?>"><img src="public/upload/watch/<?php echo $rows->img_watch; ?>" alt=""></a>
                  ...
                  <ul class="pagination pull-right" style="margin-top: 0px !important; padding-right: 15px;">
                    ...
                    <li><a href="index.php?controller=all_category_watch&p=<?php echo $id;?>&p=<?php echo $i;?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
                  </ul>   
	 			</div>
	 			</div>