...
echo "<h1>Không tìm thấy sản phẩm nào!!!</h1>";
 ?>
 <div class="col-lg-9"><h1>Kết quả tìm kiếm: <?php echo $search_name; ?></h1></div>
                    ...
                    <li><a href="index.php?controller=search_name&search_name=<?php echo $search_name; ?>&p=<?php echo $i;?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
	 				</div>
	 			</div>
	 		</div>