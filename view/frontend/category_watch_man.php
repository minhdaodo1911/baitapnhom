<div class="list_product container">
	 				<div class="row">
	 					...
	 					<!-- product -->
	 					<div class="col-lg-9">
						<?php $data = model::list_all("select * from product_watch where fk_category_watch_id=4 or fk_category_watch_id=5 or fk_category_watch_id=6 order by pk_watch_id desc limit $from,$record_per_page"); ?>
                    ...
                    <li><a href="index.php?controller=category_watch_man&p=<?php echo $i;?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
	 				</div>
	 			</div>
	 			</div>