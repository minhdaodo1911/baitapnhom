<div class="list_product container">
	 				<div class="row">
	 					...
	 					<div class="col-lg-9">
						<?php
						 $data = model::list_all("select * from product_watch where fk_category_watch_id=10 or fk_category_watch_id=11 or fk_category_watch_id=12 order by pk_watch_id desc limit $from,$record_per_page"); ?>
                    ...
                    <li><a href="index.php?controller=category_spare_part&p=<?php echo $i;?>"><?php echo $i; ?></a></li>
                <?php endfor; ?>
	 				</div>
	 			</div>
	 			</div>